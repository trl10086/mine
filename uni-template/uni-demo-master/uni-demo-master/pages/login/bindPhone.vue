<template>
	<view class="main">
		<view class="text36 black textw800 ml32 mt80">绑定手机号</view>
		...
		<view class="mt80">
			<u-button class="mh32" :custom-style="formReady ? activeStyle : inactiveStyle" :disabled="!formReady"
				@click="login">提交
			</u-button>
		</view>
		...
		methods: {
			...
			async sendCode() {
				const res = await this.$myRequest({
					url: 'c=Order&a=lowerLevelOrderList',
					data: {
